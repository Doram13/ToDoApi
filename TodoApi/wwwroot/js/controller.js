class Controller {
    ...
    editItemSave(id, title) {
        if (title.length) {
            this.sendAjax("api/todo/" + id, Controller.PUT, '{"id":' + id + ', "name":"' + title + '", "isComplete":false}', function (event) {
    ...
    toggleCompleted(id, isComplete) {
        this.sendAjax("api/todo/" + id + "/toggle_status", Controller.PUT, '{"status":' + isComplete + '}', function (event) {
            this._refresh(true);
        });
    }
